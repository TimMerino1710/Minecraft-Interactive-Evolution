...
if __name__ == "__main__":
    ...
    #import the models
    vae = load_model(f"../beta_models/z-100_d-1024/decoder-50_beta.h5",custom_objects={'Sampling': Sampling})
    painter = load_model(f"../beta_models/painter-20ep.h5",custom_objects={'mask_loss': mask_loss})

    vae.summary()
    painter.summary()

    #generate some samples and shrink
    ...
    render_house_set([np.rot90(bh,axes=(2,1)) for bh in half_samples])
    render_house_set([reassignBlock(hq) for hq in paint_samples],[0,4,20])
