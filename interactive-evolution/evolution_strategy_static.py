...
class EvolutionStrategyStatic(object):
    def __init__(self, weights, generator_init_params, sigma=0.1, learning_rate=0.2, decay=0.995):
        ...
        if self.choice_batch>1:
            self.get_reward = fitness_VAE_alltogether
        else:
            self.getreward = fitness_VAE
