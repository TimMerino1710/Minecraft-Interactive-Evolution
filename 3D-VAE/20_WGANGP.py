...
class RandomWeightedAverage(_Merge):
    ...
    def _merge_function(self, inputs):
        alpha = K.random_uniform((20, 1, 1, 1))
...
class WGANGP3D():
    def __init__(self):
        ...
        self.latent_dim = 32 * 5 * 5 * 5
        self.model_name = 'WGANGP_20_latentdim4k'
    ...
    def build_generator(self):
        ...
        model.add(Dense(32 * 5 * 5 * 5, activation="relu", input_dim=self.latent_dim))
        model.add(Reshape((5, 5, 5, 32)))
