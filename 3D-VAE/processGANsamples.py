...
categorical = decode_gan_samples('GAN_generated_samples/WGAN_model_highLR/sample_final.npy')
...
convert_to_schem(decompressed, 'GAN_generated_samples/WGAN_model_highLR/schematics_final')

# ============= binary code ===========
# process_binary_samples('GAN_generated_samples/binaryGAN_test2/', 'GAN_generated_samples/binaryGAN_test2/schematics')