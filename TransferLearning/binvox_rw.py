...
#     line = fp.readline().strip()
#
#     # TODO: removed this check cause it seemed to mess things up?
#     # if not line.startswith(b'#binvox'):
#     #     raise IOError('Not a binvox file')
#
#     # fixed this by removing the b' ' in the split, as its expecting binary
...
#
#     # TODO: added this, gets rid of the data header
#     fp.readline()
#     return dims, translate, scale
#
# def read_as_3d_array(fp, fix_coords=True):
...
#     dims, translate, scale = read_header(fp)
#
#     print("dims: ", dims, " translate: ", translate, "scale: ", scale)
#     # raw_data = np.frombuffer(fp.read(), dtype=np.uint8)
#     raw_data = np.frombuffer(str.encode(fp.read()), dtype=np.uint8)
#     print(len(raw_data))
#     # if just using reshape() on the raw data:
#     values, counts = raw_data[::2], raw_data[1::2]
#     print(raw_data[:20])
