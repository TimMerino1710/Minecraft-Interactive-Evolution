...
var CUR_STRUCTURE = []
var DEFAULT_TEXTURE_LIST = ["air","stonebrick","dirt","planks_oak","stone_slab_side","iron_bars","glass","iron_block","log_oak","wool_colored_red","stone_slab_side"];
var CUR_3D_STRUCT = [];   //the structure that is modified and rendered


var OUTMODE = "PNG";
var OUTPUT_DIR = `./output2_${OUTMODE}/`;
var PARENT_OUT_DIR = ".";
...
function placeBlock(full_data,filename){
    ...
    addMultiBlocks(full_data.alterations[CUR_SET_IDX]);
    // CUR_ACT_IDX++;
    CUR_SET_IDX++;
